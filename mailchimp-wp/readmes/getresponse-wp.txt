...
= GetResponse Forms by Optin Cat 2.6.2 =
* Add support for WordPress 7.0 admin UI updates
* Fix HTML link buttons

= GetResponse Forms by Optin Cat 2.6.1 =
...
= GetResponse Forms by Optin Cat 2.5.8 =
...
= GetResponse Forms by Optin Cat 2.5.7 =
* Fix Local optin option generating error

= GetResponse Forms by Optin Cat 2.5.6 =
* Fix reported security vulnerability with admin dismissal notice

= GetResponse Forms by Optin Cat 2.5.5 =
