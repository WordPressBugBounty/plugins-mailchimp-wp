...
Contributors: Forms for Mailchimp by Optin Cat, davidhme, fatcatapps, ryannovotny
...
**Forms for Mailchimp by Optin Cat** is a super-fast tool that lets you build beautiful looking MailChimp forms to maximize conversions and grow your mailing list.

> #### Gutenberg Compatible
> This plugin is fully compatible with WordPress 5.0's new content editor ("Gutenberg"). Simply create your MailChimp form, then add your MailChimp block to your website.
...
Forms for Mailchimp by Optin Cat allows you to build a range of MailChimp forms. These include:

*   MailChimp post boxes – MailChimp forms that you can add to your various posts or pages. Can also be added to your site as a MailChimp block using WordPress 5.0's new content editor.
...
Here are some other cool features that Forms for Mailchimp by Optin Cat comes with

*   Responsive design. Your MailChimp forms will never look out of place, no matter which device your visitors are using.
*   Post boxes can be added with a shortcode, Gutenberg MailChimp block, or automatically at the bottom of posts/pages.
...
*   Conversion optimization best practices built-in – Forms for Mailchimp by Optin Cat is the work of experienced marketers who know what makes people convert.
...
= Why bother? =
Your MailChimp list is one of your most important assets, no matter if you're a blogger, marketer or small business owner. Rely on Forms for Mailchimp by Optin Cat to build great looking forms that convert.
...
> #### Optin Cat Premium
> Forms for Mailchimp by Optin Cat Premium hels you grow your list with the following features:
...
> [Learn more about Forms for Mailchimp by Optin Cat Premium >>](https://fatcatapps.com/optincat/upgrade/m?utm_campaign=description%2Bcta&utm_source=https%3A%2F%2Fwordpress.org%2Fplugins%2Fmailchimp-wp%2F&utm_medium=referral)
...
This powerup is part of Forms for Mailchimp by Optin Cat for the sake of users that installed this plugin before June 2015. For better mobile & tablet compatibility we decided to rewrite all our CSS from scratch. This setting gives you the ability to use our old CSS instead (not recommended).
...
= What are the differences between Forms for Mailchimp by Optin Cat Free & Premium? =
> Forms for Mailchimp by Optin Cat Premium hels you get more subscribers with the following features:
